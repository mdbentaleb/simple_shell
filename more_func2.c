...
/**
 * ft_erratoi - converts ascii to int
...
/**
 * ft_print_decimal - prints a decimal
 * @input: input
 * @fd: filedescriptor
 * Return: int
 */
int ft_print_decimal(int input, int fd)
{
...
/**
 * ft_convert_number - converters int to ascii
 * @num: number
 * @base: base
 * @flags: argument
 * Return: str
